...
#cache_dir = "C:\\Users\\Lenovo\\.cache\\huggingface\\hub\\bge"
...
def query_most_similar(input_text, table_name, top_k=5):
...
# input_text = input()
# results = query_most_similar(input_text, table_name='p1', top_k=5)
